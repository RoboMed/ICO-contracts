...
contract RobomedIco is Ownable, Destructible, ERC20 {
    ...
    */
    ...
    function gotoPostIco() private returns (bool) {
        ...
        //определяем количество премиальных токенов для команды и баунти
        ...
        //member1
        localBountyAndTeam = reward(0x0, (teamTokens / 20), localBountyAndTeam);

        //member2
        localBountyAndTeam = reward(0x0, (teamTokens / 30), localBountyAndTeam);

        //last member is owner
        localBountyAndTeam = reward(owner, localBountyAndTeam, localBountyAndTeam);
